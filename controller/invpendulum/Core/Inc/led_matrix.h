...
#define LED_MATRIX_CENTER_ROW 4
...
#define LED_MATRIX_COLOR_YELLOW  ((LED_Matrix_Color_t){255, 255, 0})
#define LED_MATRIX_COLOR_CYAN    ((LED_Matrix_Color_t){0, 255, 255})
#define LED_MATRIX_COLOR_MAGENTA ((LED_Matrix_Color_t){255, 0, 255})
